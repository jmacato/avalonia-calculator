    ...
    DateTimeOffset now)
{
    ...
    private TelemetryStoreSessionStateState _state = new(runId, remoteAddress, now, null, null, 0, default, default, -1, false, 0, Array.Empty<TelemetryTimelineSample>(), Array.Empty<TelemetryEventView>(), Array.Empty<TelemetryInputTraceChunk>());
