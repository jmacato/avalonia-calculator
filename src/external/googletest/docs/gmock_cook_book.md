...
method where the specific overload is ambiguous. You can handle this by
...
not have to build it from initial construction every time. If the action doesn't have an
...
[alternatives](#LegacyMoveOnly) for lack of this feature.
...
#### Legacy alternatives for move-only types {#LegacyMoveOnly}

Support for move-only function arguments was only introduced to gMock in April
of 2017. In older code, you may encounter the following alternative for the lack
