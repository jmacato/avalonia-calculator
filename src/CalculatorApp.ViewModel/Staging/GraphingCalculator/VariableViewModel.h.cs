...
namespace CalculatorApp.ViewModel
{
    ...
    public partial class VariableViewModel : INotifyPropertyChanged
    {
        ...
        public string VariableAutomationName
        {
            get
            {
                return CalculatorApp.ViewModel.Common.LocalizationStringUtil.GetLocalizedString(CalculatorApp.ViewModel.Common.AppResourceProvider.Instance.GetResourceString("VariableListViewItem"), Name);
            }
        }
