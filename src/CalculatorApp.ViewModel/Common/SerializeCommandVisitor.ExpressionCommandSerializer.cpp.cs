...
public partial class SerializeCommandVisitor : ISerializeCommandVisitor
{
    ...
    public void Visit(COpndCommand opndCmd)
    {
        if (opndCmd is null)
        {
            throw new ArgumentNullException(nameof(opndCmd));
        }
    ...
    public void Visit(CUnaryCommand unaryCmd)
    {
        if (unaryCmd is null)
        {
            throw new ArgumentNullException(nameof(unaryCmd));
        }
    ...
    {
        if (binaryCmd is null)
        {
            throw new ArgumentNullException(nameof(binaryCmd));
        }
    ...
    public void Visit(CParentheses paraCmd)
    {
        if (paraCmd is null)
        {
            throw new ArgumentNullException(nameof(paraCmd));
        }
