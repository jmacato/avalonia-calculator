...
internal static class CooperEliminator
{
    public static bool TryEliminateExists(string variable, PresburgerFormula source, ResourceBudget budget, out PresburgerFormula result)
    {
        ...
        if (operands.Any(operand => operand is PresburgerDivisibility or PresburgerNot))
        {
            result = null!;
            return false;
        }
    ...
    private static PresburgerComparison SubstituteComparison(string variable, ExactInteger equalityCoefficient, LinearIntegerExpression equalityRemainder, PresburgerComparison comparison)
    {
    ...
    private static PresburgerDivisibility SubstituteDivisibility(string variable, ExactInteger equalityCoefficient, LinearIntegerExpression equalityRemainder, PresburgerDivisibility divisibility)
    {
