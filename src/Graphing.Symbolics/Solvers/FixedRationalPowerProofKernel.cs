...
internal static class FixedRationalPowerProofKernel
{
    ...
    private static int FirstDerivativeSign(FixedRationalPowerContext context, CellDecompositionCertificate chart, FixedRationalPowerProofKernelDifferentialData differential, CellWitness cell)
    {
        return context.Exponent.Sign * RationalSign(chart, differential.First, cell);
    }

    private static int CurvatureSign(FixedRationalPowerContext context, CellDecompositionCertificate chart, FixedRationalPowerProofKernelDifferentialData differential, CellWitness cell)
    {
