...
internal static class HalfAngleReducer
{
    ...
    {
        return RationalFunction.CreateReduced(
            UnivariatePolynomial.Create([BigRational.Zero, new BigRational(2)], budget),
            UnivariatePolynomial.Create([BigRational.One, BigRational.Zero, BigRational.One], budget), budget);
    }

    private static RationalFunction Cosine(ResourceBudget budget)
    {
        return RationalFunction.CreateReduced(
            UnivariatePolynomial.Create([BigRational.One, BigRational.Zero, BigRational.MinusOne], budget),
            UnivariatePolynomial.Create([BigRational.One, BigRational.Zero, BigRational.One], budget), budget);
    }
