...
public class UnitConverter : IUnitConverter
{
    ...
    internal IViewModelCurrencyCallback? CurrencyCallback => m_vmCurrencyCallback;
    ...
    public void SendCommand(Command command)
    {
        ...
        if (clearFront)
        {
            m_currentDisplay = m_currentDisplay.Substring(1); // Remove the first character
        }
    ...
    /// </summary>
    internal void ReloadCurrencyData()
    {
