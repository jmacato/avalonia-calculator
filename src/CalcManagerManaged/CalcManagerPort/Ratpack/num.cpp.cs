...
public partial class RatPak
{
    ...
    public void addnum(ref PNUMBER pa, PNUMBER b, uint32_t radix)
    {
    ...
    public void mulnum(ref PNUMBER pa, PNUMBER b, uint32_t radix)
    {
    ...
    public void divnum(ref PNUMBER pa, PNUMBER b, uint32_t radix, int32_t precision)
    {
        if (b.cdigit > 1 || b.mant[0] != 1 || b.exp != 0)
        {
            // b is not one
    ...
    public bool equnum(PNUMBER a, PNUMBER b)
    {
        int32_t diff;
        MANTTYPE[] pa;
        MANTTYPE[] pb;
