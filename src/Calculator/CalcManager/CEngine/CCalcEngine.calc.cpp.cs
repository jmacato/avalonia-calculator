...
internal sealed partial class CCalcEngine
{
...

    {
        ...
        m_nFE = (RatPakNumberFormat.Float);
        ...
        m_nLastCom = (0);
        m_angletype = (RatPakAngleType.Degrees);
        m_numwidth = (CCalcEngineNUM_WIDTH.QWORD_WIDTH);
    ...
    void InitChopNumbers()
    {
        ...
        for (int i = 0; i < m_chopNumbers.Length; i++)
        {
            ...
            m_maxDecimalValueStrings[i] = maxVal.ToString(10, RatPakNumberFormat.Float, m_precision);
        }
    }
