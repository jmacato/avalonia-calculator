...
internal sealed partial class CCalcEngine
{
    ...
    // dont change that.
    public void SetRadixTypeAndNumWidth(RadixType radixtype, CCalcEngineNUM_WIDTH numwidth)
    {
        ...
        if (numwidth >= CCalcEngineNUM_WIDTH.QWORD_WIDTH && numwidth <= CCalcEngineNUM_WIDTH.BYTE_WIDTH)
        {
            m_numwidth = numwidth;
    ...
    public static uint32_t DwWordBitWidthFromNumWidth(CCalcEngineNUM_WIDTH numwidth)
    {
        switch (numwidth)
        {
            case CCalcEngineNUM_WIDTH.DWORD_WIDTH:
                return 32;
            case CCalcEngineNUM_WIDTH.WORD_WIDTH:
                return 16;
            case CCalcEngineNUM_WIDTH.BYTE_WIDTH:
                return 8;
            case CCalcEngineNUM_WIDTH.QWORD_WIDTH:
            default:
                return 64;
        }
    }
    ...
    private bool TryToggleBit(ref Rational rat, uint32_t wbitno)
    {
        ...
        Rational result = RationalMath.Integer(m_ratPak, rat);
