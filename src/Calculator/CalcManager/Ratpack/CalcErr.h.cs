...
public enum CalcErr : uint32_t
{
    ...
    CALC_E_DIVIDEBYZERO = (uint32_t)0x80000000,

    // CALC_E_DOMAIN
    //
    // The given input is not within the domain of this function
    CALC_E_DOMAIN = (uint32_t)0x80000001,

    // CALC_E_INDEFINITE
    //
    // The result of this function is undefined
    CALC_E_INDEFINITE = (uint32_t)0x80000002,

    // CALC_E_POSINFINITY
    //
    // The result of this function is Positive Infinity.
    CALC_E_POSINFINITY = (uint32_t)0x80000003,

    // CALC_E_NEGINFINITY
    //
    // The result of this function is Negative Infinity
    CALC_E_NEGINFINITY = (uint32_t)0x80000004,
    ...
    CALC_E_INVALIDRANGE = (uint32_t)0x80000006,

    // CALC_E_OUTOFMEMORY
    //
    // There is not enough free memory to complete the requested function
    CALC_E_OUTOFMEMORY = (uint32_t)0x80000007,

    // CALC_E_OVERFLOW
    //
    // The result of this operation is an overflow
    CALC_E_OVERFLOW = (uint32_t)0x80000008,
