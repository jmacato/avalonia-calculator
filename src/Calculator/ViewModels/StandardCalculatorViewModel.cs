...
public sealed partial class StandardCalculatorViewModel : INotifyPropertyChanged, ICalcDisplay
{
    ...
    {
        get => m_IsBinaryBitFlippingEnabled;
    ...
    {
        get => m_IsOperandUpdatedUsingViewModel;

        private set => m_IsOperandUpdatedUsingViewModel = value;
    }
    ...
    public int TokenPosition
    {
        ...
        private set => m_TokenPosition = value;
    }
    ...
    {
        get => m_IsOperandTextCompletelySelected;

        private set => m_IsOperandTextCompletelySelected = value;
    }
    ...
    {
        get => m_SelectedExpressionLastData;

        private set => m_SelectedExpressionLastData = value;
    }
    ...
    public static string IsInErrorPropertyName => "IsInError";

    // OBSERVABLE_PROPERTY_R(bool, IsOperatorCommand)
    public bool IsOperatorCommand
    {
        get => m_IsOperatorCommand;
    ...
    private ObservableCollection<DisplayExpressionToken> m_ExpressionTokens;
    // OBSERVABLE_PROPERTY_R(Platform.String, DecimalDisplayValue)
    public string DecimalDisplayValue
    {
        get => m_DecimalDisplayValue;
    ...
    public static string BinaryDisplayValuePropertyName => "BinaryDisplayValue";
    ...
    {
        get => m_DecDisplayValueAutomationName;
    ...
    {
        get => m_OctDisplayValueAutomationName;
    ...
    {
        get => m_BinDisplayValueAutomationName;
    ...
    public static string IsMemoryEmptyPropertyName => "IsMemoryEmpty";
    ...
    {
        get => m_CalculationResultAutomationName;
    ...
    {
        get => m_CalculationExpressionAutomationName;
    ...
    {
        get => m_IsShiftProgrammerChecked;
    ...
    {
        get => m_AreAlwaysOnTopResultsUpdated;
    ...
    {
        get => m_AreProgrammerRadixOperatorsVisible;
    ...
    public ICommand CopyCommand => donotuse_CopyCommand ??= new DelegateCommand(OnCopyCommand);

    private ICommand? donotuse_CopyCommand;
    // COMMAND_FOR_METHOD(PasteCommand, StandardCalculatorViewModel.OnPasteCommand)
    public ICommand PasteCommand => donotuse_PasteCommand ??= new DelegateCommand(OnPasteCommand);

    private ICommand? donotuse_PasteCommand;
    // COMMAND_FOR_METHOD(ButtonPressed, StandardCalculatorViewModel.OnButtonPressed)
    public ICommand ButtonPressed => donotuse_ButtonPressed ??= new DelegateCommand(OnButtonPressed);
    ...
    public ICommand ClearMemoryCommand => donotuse_ClearMemoryCommand ??= new DelegateCommand(OnClearMemoryCommand);
    ...
    public ICommand MemoryItemPressed => donotuse_MemoryItemPressed ??= new DelegateCommand(OnMemoryItemPressed);

    private ICommand? donotuse_MemoryItemPressed;
    // COMMAND_FOR_METHOD(MemoryAdd, StandardCalculatorViewModel.OnMemoryAdd)
    public ICommand MemoryAdd => donotuse_MemoryAdd ??= new DelegateCommand(OnMemoryAdd);

    private ICommand? donotuse_MemoryAdd;
    // COMMAND_FOR_METHOD(MemorySubtract, StandardCalculatorViewModel.OnMemorySubtract)
    public ICommand MemorySubtract => donotuse_MemorySubtract ??= new DelegateCommand(OnMemorySubtract);
    ...
    public static string IsBitFlipCheckedPropertyName => "IsBitFlipChecked";

    // Custom property ValueBitLength
    private BitLength m_valueBitLength;
    public BitLength ValueBitLength
    {
        get => m_valueBitLength;

        set => ValueBitLengthSet(value);
    }
    ...
    public static string IsProgrammerPropertyName => "IsProgrammer";

    // Custom property IsEditingEnabled
    private bool m_isEditingEnabled;
    public bool IsEditingEnabled
    {
        get => m_isEditingEnabled;
    ...
    public bool IsEngineRecording => m_standardCalculatorManager.IsEngineRecording();

    // Custom property IsOperandEnabled
    private bool m_isOperandEnabled;
    public bool IsOperandEnabled
    {
        get => m_isOperandEnabled;
    ...
    CalculatorButtonId GetCurrentAngleType()
    {
    ...
    CalculatorButtonId m_CurrentAngleType;
    char m_decimalSeparator;
    CalculatorDisplay m_calculatorDisplay = new();
    EngineResourceProvider m_resourceProvider = new();
