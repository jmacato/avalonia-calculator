...
public sealed partial class GraphingCalculatorViewModel : ViewModelBase
{
    ...
    public void RequestInput(GraphingInputAction action, string text = "", int cursorOffset = 0, int selectionLength = 0)
    {
        InputRequested?.Invoke(this, new GraphingInputRequestedEventArgs(action, text, cursorOffset, selectionLength));
    }
    ...
    private static (string Text, int CursorOffset, int SelectionLength) ButtonOutput(CalculatorButtonId operation)
    {
