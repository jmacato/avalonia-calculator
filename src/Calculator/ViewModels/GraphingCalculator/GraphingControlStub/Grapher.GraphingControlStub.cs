...
{
    internal sealed class Grapher : UserControl
    {
        ...
        public IDictionary<string, Variable> Variables { get => (IDictionary<string, Variable>)GetValue(VariablesProperty); set => SetValue(VariablesProperty, value); }
        public EquationCollection Equations { get => (EquationCollection)GetValue(EquationsProperty); set => SetValue(EquationsProperty, value); }
        ...
        private readonly Graphing.MathSolverImplementation _solver;
        ...
        public Grapher()
        {
            ...
            // var coreWindow = AppWindow.Create();
        ...
        private async void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            await TryUpdateGraph(false).ConfigureAwait(true);
        }
        ...
        {
            System.ArgumentNullException.ThrowIfNull(equation); var graph = GetGraph(equation);
            if (graph == null)
                return null;
            SetGraphArgs(graph);
        ...
        public void GetDisplayRanges(out double xMin, out double xMax, out double yMin, out double yMax)
        {
            ...
            catch (Exception exception) when (exception is InvalidOperationException or ArgumentException or System.Runtime.InteropServices.COMException)
            {
        ...
        {
            if (await TryUpdateGraph(keepCurrentView).ConfigureAwait(false))
            {
                SetEquationsAsValid();
            }
            else
            {
                ...
                if (shouldRetry)
                {
                    await TryUpdateGraph(keepCurrentView).ConfigureAwait(false);
                }
            }
            ...
            if (_renderMain != null && _graph != null)
            {
                ...
                if (graphExpression != null)
                {
                    ...
                    if (initResult != null)
                    {
                        ...
                        bool renderSuccess = await _renderMain.RunRenderPassAsync().ConfigureAwait(false);
                        if (renderSuccess)
                        {
                            UpdateVariables();
                            successful = true;
                ...
                if (initResult == null && !shouldKeepPreviousGraph)
                {
                    ...
                    if (initResult != null)
                    {
                        ...
                        SetGraphArgs(_graph);
                        _renderMain.Graph = _graph;
                        await _renderMain.RunRenderPassAsync().ConfigureAwait(false);
                        UpdateVariables();
        ...
        private void UpdateTracingChanged()
        {
            ...
            if (renderMain.Tracing)
            {
                ...
                TracingValueChangedEvent?.Invoke(renderMain.XTraceValue, renderMain.YTraceValue);
            }
            else
            {
        ...
        private static void OnForceProportionalAxesPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            _ = grapher.TryUpdateGraph(false);
        }
        ...
        private static async void OnGridLinesColorPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (grapher._renderMain != null && grapher._graph != null)
            {
                ...
                await grapher._renderMain.RunRenderPassAsync().ConfigureAwait(false);
            }
        }
        ...
        {
            System.ArgumentNullException.ThrowIfNull(e); if (_renderMain != null)
            {
                OnPointerMoved(e);
                e.Handled = true;
            }
        ...
        protected override void OnPointerMoved(PointerRoutedEventArgs e)
        {
            System.ArgumentNullException.ThrowIfNull(e); if (_renderMain != null)
            {
                ...
                if (_renderMain.ActiveTracing)
                {
                    ...
                    {
                        // _cachedCursor = AppWindow.Create().PointerCursor;
                        // AppWindow.Create().PointerCursor = null;
                    }
                }
                else if (_cachedCursor != null)
                {
                    _renderMain.PointerLocation = currPosition;
                    // AppWindow.Create().PointerCursor = _cachedCursor;
                    // _cachedCursor = null;
                    UpdateTracingChanged();
                }
                else
        ...
        {
            System.ArgumentNullException.ThrowIfNull(e); var currentPointer = e.GetCurrentPoint(this);
        ...
        {
            System.ArgumentNullException.ThrowIfNull(e);            // Set the pointer capture to the element being interacted with so that only it
        ...
        {
            System.ArgumentNullException.ThrowIfNull(e); ReleasePointerCapture(e.Pointer);
        ...
        {
            System.ArgumentNullException.ThrowIfNull(e); if (_renderMain != null && _graph != null)
            {
                var renderer = _graph.GetRenderer();
                if (renderer != null)
                {
