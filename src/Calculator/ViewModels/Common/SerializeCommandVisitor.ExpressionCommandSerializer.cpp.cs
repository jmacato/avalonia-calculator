...
internal sealed partial class SerializeCommandVisitor : ISerializeCommandVisitor
{
    ...
    {
        System.ArgumentNullException.ThrowIfNull(opndCmd); m_dataWriter.WriteBoolean(opndCmd.IsNegative());
    ...
    {
        System.ArgumentNullException.ThrowIfNull(unaryCmd); var cmds = unaryCmd.GetCommands();
    ...
    {
        System.ArgumentNullException.ThrowIfNull(binaryCmd); int cmd = binaryCmd.GetCommand();
        m_dataWriter.WriteInt32(cmd);
    }

    public void Visit(CParentheses paraCmd)
    {
        System.ArgumentNullException.ThrowIfNull(paraCmd); int parenthesisCmd = paraCmd.GetCommand();
