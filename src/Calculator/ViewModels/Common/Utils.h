...
#define OBSERVABLE_OBJECT()                                                                                                                                    \
    ...
    {                                                                                                                                                          \
        PropertyChanged(this, new  Windows.UI.Xaml.Data.PropertyChangedEventArgs(p));                                                                   \
    }                                                                                                                                                          \
                                                                                                                                                               \
public:
#else
...
#define COMMAND_FOR_METHOD(p, m)                                                                                                                               \
    ...
    {                                                                                                                                                          \
        ...
        {                                                                                                                                                      \
            if (!donotuse_##p)                                                                                                                                 \
            {                                                                                                                                                  \
                donotuse_##p = new  CalculatorApp.ViewModel.Common.DelegateCommand(                                                                \
...
#define DEPENDENCY_PROPERTY_DECLARATION(t, n)                                                                                                                  \
    ...
    {                                                                                                                                                          \
        t get()                                                                                                                                                \
        {                                                                                                                                                      \
            return (t)(GetValue(s_##n##Property));                                                                                                    \
        }                                                                                                                                                      \
        void set(t value)                                                                                                                                      \
        {                                                                                                                                                      \
...
namespace Utils
{
    namespace Details
    {
        ...
        template <typename T>
        typename enable_if<IsRefClass<T>.value, T>.type MakeDefault()
        {
            return null;
        }
        ...
        {
            typedef typename conditional<is_enum<T>.value, object, T>.type type;
        };
    }
    ...
    Windows.UI.Xaml.DependencyProperty^ RegisterDependencyProperty(
           string   name,
         Windows.UI.Xaml.PropertyMetadata^ metadata)
    {
        ...
        return Windows.UI.Xaml.DependencyProperty.Register(
            ...
            ThisDependencyPropertyType.typeid, // Use the filtered type for XAML compatibility
            OwnerType.typeid,
            metadata);
    }

    template <typename TOwner, typename TType>
    Windows.UI.Xaml.DependencyProperty^ RegisterDependencyProperty(   string   name)
    {
        typedef typename Details.RemoveHat<TType>.type ThisPropertyType;

        return RegisterDependencyProperty<TOwner, TType>(
            name,
            new  Windows.UI.Xaml.PropertyMetadata(Details.MakeDefault<ThisPropertyType>()));
    }

    template <typename TOwner, typename TType>
    Windows.UI.Xaml.DependencyProperty^ RegisterDependencyProperty(   string   name, TType defaultValue)
    {
        return RegisterDependencyProperty<TOwner, TType>(
            name,
            new  Windows.UI.Xaml.PropertyMetadata(defaultValue));
    }
        ...
        TCallback callback)
    {
        ...
        return RegisterDependencyProperty<TOwner, TType>(
            name,
            new  Windows.UI.Xaml.PropertyMetadata(
                Details.MakeDefault<ThisPropertyType>(),
                new  Windows.UI.Xaml.PropertyChangedCallback(callback)));
    }
    ...
    template <typename TOwner, typename TType>
    Windows.UI.Xaml.DependencyProperty^ RegisterDependencyPropertyAttached(   string   name)
    {
        typedef typename Details.RemoveHat<TType>.type ThisPropertyType;
    ...
    template <typename TOwner, typename TType>
    Windows.UI.Xaml.DependencyProperty^ RegisterDependencyPropertyAttached(   string   name, TType defaultValue)
    {
        return RegisterDependencyPropertyAttached<TOwner, TType>(
            name,
            new  Windows.UI.Xaml.PropertyMetadata(defaultValue));
    ...
    bool IsLastCharacterTarget(string const& input,  char  target);

    // Return string after removing characters specified by unwantedChars array
    template <size_t N>
    string RemoveUnwantedCharsFromString(string inputString,  string  (&unwantedChars)[N])
    {
        for ( string  unwantedChar : unwantedChars)
        {
            inputString.erase(remove(inputString.begin(), inputString.end(), unwantedChar), inputString.end());
        }
        return inputString;
    }

    double GetDoubleFromstring(string input);
    void RunOnUIThreadNonblocking(function<void()>&& function,  Windows.UI.Core.CoreDispatcher currentDispatcher);

    Windows.Foundation.DateTime GetUniversalSystemTime();
    bool IsDateTimeOlderThan(Windows.Foundation.DateTime dateTime, const long duration);
    ...
    void TrimFront(string& value);
    void TrimBack(string& value);
}
...
#define DEPENDENCY_PROPERTY(type, name)                                                                                                                        \
    ...
    {                                                                                                                                                          \
        type get()                                                                                                                                             \
        {                                                                                                                                                      \
            return (type)(GetValue(s_##name##Property));                                                                                              \
        }                                                                                                                                                      \
        void set(type value)                                                                                                                                   \
        {                                                                                                                                                      \
...
private:                                                                                                                                                       \
    ...
    {                                                                                                                                                          \
        var self = (DependencyPropertiesOwner)(sender);                                                                                            \
        self.On##name##PropertyChanged((type)(args.OldValue), (type)(args.NewValue));                                                     \
    }                                                                                                                                                          \
                                                                                                                                                               \
public:
...
private:                                                                                                                                                       \
    ...
    {                                                                                                                                                          \
        var self = (DependencyPropertiesOwner)(sender);                                                                                            \
        self.On##name##PropertyChanged((type)(args.OldValue), safe_cast<type>(args.NewValue));                                                     \
    }                                                                                                                                                          \
                                                                                                                                                               \
public:
...
// Define a template specialization for equal_to.
template<>
class equal_to<Windows.UI.Color>
{
public:
