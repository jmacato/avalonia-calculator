...
namespace CalculatorApp.ViewModel
{
    namespace Common
    {
        internal sealed partial class LocalizationSettings
        {
            ...
            {
                return GetDigitSymbolFromEnUsDigit('0') == '0';
            }
            ...
            {
                ArgumentNullException.ThrowIfNull(stringToLocalize);
                if (Instance.IsDigitEnUsSetting())
                {
                    return;
                }
                ...
                for (int chI = 0; chI < ret.Length; chI++)
                {
                    ...
                    if (IsEnUsDigit(ch))
                    {
                        ret[chI] = Instance.GetDigitSymbolFromEnUsDigit(ch);
                    }
                }
