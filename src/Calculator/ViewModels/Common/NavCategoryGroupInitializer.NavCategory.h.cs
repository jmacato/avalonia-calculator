...
namespace CalculatorApp.ViewModel
{
    namespace Common
    {
        internal sealed class NavCategoryGroupInitializer
        {
            ...
            internal CategoryGroupType Type { get; }

            internal string HeaderResourceKey { get; }

            internal string ModeResourceKey { get; }

            internal string AutomationResourceKey { get; }
        }
    }
}
