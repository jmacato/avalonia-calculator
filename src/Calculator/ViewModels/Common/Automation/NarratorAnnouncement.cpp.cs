...
namespace CalculatorApp.ViewModel.Common.Automation
{
    ...
    {
        public static string DisplayUpdated = "DisplayUpdated";
        public static string MaxDigitsReached = "MaxDigitsReached";
        public static string MemoryCleared = "MemoryCleared";
        public static string MemoryItemChanged = "MemorySlotChanged";
        public static string MemoryItemAdded = "MemorySlotAdded";
        public static string HistoryCleared = "HistoryCleared";
        public static string HistorySlotCleared = "HistorySlotCleared";
        public static string CategoryNameChanged = "CategoryNameChanged";
        public static string UpdateCurrencyRates = "UpdateCurrencyRates";
        public static string DisplayCopied = "DisplayCopied";
        public static string OpenParenthesisCountChanged = "OpenParenthesisCountChanged";
        public static string NoParenthesisAdded = "NoParenthesisAdded";
        public static string GraphModeChanged = "GraphModeChanged";
        public static string GraphViewChanged = "GraphViewChanged";
        public static string FunctionRemoved = "FunctionRemoved";
        public static string GraphViewBestFitChanged = "GraphViewBestFitChanged";
        public static string AlwaysOnTop = "AlwaysOnTop";
        public static string BitShiftRadioButtonContent = "BitShiftRadioButtonContent";
        public static string SettingsPageOpened = "SettingsPageOpened";
    }
}
...
namespace CalculatorApp.ViewModel.Common.Automation
{
    ...
    public partial class NarratorAnnouncement
    {
      ...
      m_announcement;
        ...
        public AutomationNotificationKind Kind
        {
            get => m_kind;
        }

        public AutomationNotificationProcessing Processing
        {
            get => m_processing;
        }
