...
namespace CalculatorApp.ViewModel.Common.Automation
{
    public partial class NarratorAnnouncement
    {
        ...
        string m_announcement = announcement;
        string m_activityId = activityId;
        AutomationNotificationKind m_kind = kind;
        AutomationNotificationProcessing m_processing = processing;
        //internal:
