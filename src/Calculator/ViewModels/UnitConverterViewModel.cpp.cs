...
public partial class UnitConverterViewModel
{
    ...
    {
        if ((m_Unit1 == null) || (m_Unit2 == null) || (m_Unit2 == Unit.EMPTY_UNIT) || (m_Unit2 == Unit.EMPTY_UNIT))
        {
        ...
        if (IsCurrencyCurrentCategory)
            ...
            try
            {
                // TODO: This is hacky as fudge. There's gotta be a better way of doing this.
                var k = new CurrencyFormatter(m_Unit1.abbreviation);
                var z = new CurrencyFormatter(m_Unit2.abbreviation);
    ...
    String ConvertToLocalizedString(string stringToLocalize, bool allowPartialStrings, CurrencyFormatterParameter cfp)
    {
        ...
        if (posOfE != -1)
        {
            ...
            string exponentStr = stringToLocalize.Substring(posOfSign + 1, stringToLocalize.Length - (posOfSign + 1));
    ...
    void RestoreUserPreferences()
    {
        if (!IsCurrencyCurrentCategory)
        {
            // Check this later for a more cross platform way.
