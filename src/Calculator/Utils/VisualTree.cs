...
namespace Calculator.Utils
{
    ...
    internal static class VisualTree
    {
        ...
        internal static FrameworkElement? FindDescendantByName(DependencyObject element, string name)
        {
            ...
            if (element is FrameworkElement frameworkElement && name.Equals(frameworkElement.Name, StringComparison.Ordinal))
            {
        ...
        private static FrameworkElement? FindAscendantByName(DependencyObject element, string name)
        {
            ...
            if (parent is FrameworkElement frameworkElement && name.Equals(frameworkElement.Name, StringComparison.Ordinal))
            {
                return frameworkElement;
            }
