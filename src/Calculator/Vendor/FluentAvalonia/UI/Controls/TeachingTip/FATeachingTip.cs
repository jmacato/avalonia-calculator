...
public partial class FATeachingTip : ContentControl
{
    ...
    // Playing a closing animation when the Teaching Tip is closed via light dismiss requires this handling.
    ...
    // the close and play our animation first. To handle this we've created a second popup which has no content and sits
    ...
    private void OnTargetChanged()
    {
        ...
        {
            // Implementation detail: if the target is changed when the teaching tip is closed, it won't open at the new target
            //       Not sure how WinUI handles this, or if its a bug in general, so I'm just tacking this
            //       temporary fix in here to handle this until I can look into this more
    ...
    private void StartExpandToOpen()
    {
        ...
        // Implementation detail: CenterPoint on CompositionVisual resets after animation probably because the element is in a popup
        ...
        // Since we don't have ScopedBatch animation yet, we coordinate completion explicitly to await the
