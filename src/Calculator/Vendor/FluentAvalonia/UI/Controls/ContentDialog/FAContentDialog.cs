...
public partial class FAContentDialog : ContentControl, ICustomKeyboardNavigation
{
    ...
    protected override void OnKeyUp(KeyEventArgs e)
    {
        ...
        // Implementation detail: If a default button is set, and the content dialog is opened by enter or escape key press on a button
    ...
    private async void FinalCloseDialog()
    {
        ...
        // below to fail (as this would be removed from the tree). This is the required handling
