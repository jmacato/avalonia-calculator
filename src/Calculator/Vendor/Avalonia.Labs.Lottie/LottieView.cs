...
/// </summary>
public sealed class LottieView : Control, IDisposable
{
    ...
    private LottieCompositionCustomVisualHandler? _handler;
    ...
    public static readonly StyledProperty<string?> PathProperty =
        AvaloniaProperty.Register<LottieView, string?>(nameof(Path));

    /// <summary>
    /// Defines the <see cref="Stretch"/> property.
    /// </summary>
    public static readonly StyledProperty<Stretch> StretchProperty =
        AvaloniaProperty.Register<LottieView, Stretch>(nameof(Stretch), Stretch.Uniform);
    ...
    /// </summary>
    public event EventHandler<AnimationCompletedRepetitionEventArgs>? AnimationCompletedRepetition;

    /// <summary>
    /// Initializes a new instance of the <see cref="LottieView"/> class.
    /// </summary>
    /// <param name="baseUri">The base URL for the XAML context.</param>
    public LottieView(Uri baseUri)
    {
        _baseUri = baseUri;
    }
    ...
    public LottieView(IServiceProvider serviceProvider)
    {
    ...
    protected override void OnLoaded(RoutedEventArgs e)
    {
        ...
        _handler = new LottieCompositionCustomVisualHandler();
        try
        {
    ...
    private void ReportLoadFailure(Exception exception)
    {
        Logger
            .TryGet(LogEventLevel.Warning, LogArea.Control)?
            .Log(this, "Failed to load animation: " + exception);
        _animation = null;
    }
    ...
    {
        AnimationCompletedRepetition?.Invoke(this, new AnimationCompletedRepetitionEventArgs(repetition));
    }
