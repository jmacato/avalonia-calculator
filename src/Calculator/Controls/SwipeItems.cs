...
{
    public static readonly StyledProperty<SwipeMode> ModeProperty =
        AvaloniaProperty.Register<SwipeItems, SwipeMode>(nameof(Mode), SwipeMode.Reveal);
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        if (change.Property == ModeProperty &&
            change.NewValue is SwipeMode.Execute &&
            Count > 1)
        {
