...
internal sealed class ManagedMathSolver : IMathSolver
{
    ...
    public IParsingOptions ParsingOptions()
    {
        return _parsingOptions;
    }

    public IEvalOptions EvalOptions()
    {
        return _evaluationOptions;
    }

    public IFormatOptions FormatOptions()
    {
    ...
    public IGraph CreateGrapher()
    {
        return new ManagedGraph(_evaluationOptions);
    }
