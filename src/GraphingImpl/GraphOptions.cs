...
{
    private static readonly ImmutableArray<Color> DefaultPalette =
    [
        new Color(0x00, 0x63, 0xB1),
        new Color(0xC4, 0x2B, 0x1C),
        new Color(0x10, 0x7C, 0x10),
        new Color(0x87, 0x64, 0xB8),
        new Color(0xCA, 0x50, 0x10),
        new Color(0x03, 0x83, 0x87),
        new Color(0x8E, 0x56, 0x2F),
        new Color(0xE3, 0x00, 0x8C)
    ];
    ...
    internal Color ColorForEquation(int index) =>
        _graphColors.IsEmpty ? DefaultPalette[index % DefaultPalette.Length] : _graphColors[index % _graphColors.Length];
