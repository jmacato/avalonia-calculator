...
internal sealed class ManagedGraph : IGraph, IDisposable
{
    ...
    public GraphStatus GetInitializationError()
    {
        return (GraphStatus)Volatile.Read(ref _initializationError);
    }

    public IGraphingOptions GetOptions()
    {
        return _options;
    }
    ...
    {
        return Volatile.Read(ref _snapshot).Variables;
    }
    ...
    public IGraphAnalyzer GetAnalyzer()
    {
        return _analyzer;
    }
    ...
    {
        return Volatile.Read(ref _selectedEquation) == equationId;
    }
