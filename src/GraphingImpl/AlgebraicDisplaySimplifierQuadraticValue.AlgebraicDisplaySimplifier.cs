...
internal readonly record struct AlgebraicDisplaySimplifierQuadraticValue(BigRational RationalPart, BigRational RadicalCoefficient, ExactInteger Radicand)
{
    ...
    public static AlgebraicDisplaySimplifierQuadraticValue Rational(BigRational value) => new(value, BigRational.Zero, ExactInteger.Zero);
    public static AlgebraicDisplaySimplifierQuadraticValue Create(BigRational rational, BigRational radicalCoefficient, ExactInteger radicand) => radicalCoefficient.IsZero ? Rational(rational) : new AlgebraicDisplaySimplifierQuadraticValue(rational, radicalCoefficient, radicand);
    public AlgebraicDisplaySimplifierQuadraticValue Negate() => Create(-RationalPart, -RadicalCoefficient, Radicand);
    ...
    public AlgebraicDisplaySimplifierQuadraticValue Subtract(AlgebraicDisplaySimplifierQuadraticValue other) => Add(other.Negate());
    public AlgebraicDisplaySimplifierQuadraticValue Multiply(BigRational scalar) => Create(RationalPart * scalar, RadicalCoefficient * scalar, Radicand);
