...
{
    public static AlgebraicDisplaySimplifierExtensionValue Rational(BigRational value) => new(AlgebraicDisplaySimplifierQuadraticValue.Rational(value), AlgebraicDisplaySimplifierQuadraticValue.Rational(BigRational.Zero));
    public static AlgebraicDisplaySimplifierExtensionValue Argument() => new(AlgebraicDisplaySimplifierQuadraticValue.Rational(BigRational.Zero), AlgebraicDisplaySimplifierQuadraticValue.Rational(BigRational.One));
    public AlgebraicDisplaySimplifierExtensionValue Add(AlgebraicDisplaySimplifierExtensionValue other) => new(Even.Add(other.Even), Odd.Add(other.Odd));
    public AlgebraicDisplaySimplifierExtensionValue Multiply(AlgebraicDisplaySimplifierExtensionValue other, AlgebraicDisplaySimplifierQuadraticValue square) => new(Even.Multiply(other.Even).Add(Odd.Multiply(other.Odd).Multiply(square)), Even.Multiply(other.Odd).Add(Odd.Multiply(other.Even)));
